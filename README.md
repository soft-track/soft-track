...
**After that:** burndown/velocity reports, GitHub/GitLab branch and PR linking,
sending invitations by email (SMTP), and OAuth login.
...
There is deliberately no "every Monday", no OR, no negation and no branching.
